...
const Board: React.FC = () => {
  ...
  const renderDaniaExport = () => {
    ...
    if (colUnits <= 5.0) {
      // Extremely sparse (e.g. 2-3 items/col)
      containerClass = "py-8";
      nameSize = "text-6xl";
      metaSize = "text-5xl";
      priceSize = "text-6xl";
    } else if (colUnits <= 7.5) {
      // Sparse (e.g. 4-5 items/col)
      containerClass = "py-6";
      nameSize = "text-5xl";
      metaSize = "text-4xl";
      priceSize = "text-5xl";
      ...
      // Very Dense (>19.5 units/col)
      containerClass = "py-0";
      nameSize = "text-[35px] leading-[39px]";
      metaSize = "text-[30px] leading-[34px]";
      priceSize = "text-[35px] leading-[39px]";
    }
